...
class PorterStemmer:
    ...
    def __init__(self):
        # buffer for word to be stemmed and j is a general offset into the string.
        self.b = ""
        self.k = 0
        self.k0 = 0
        self.j = 0
    ...
    def double_c(self, j):
        # if it is TRUE, it has a double consonant
        if j < (self.k0 + 1):
            return 0
    ...
    def step_one_ab(self):
        # removing plural suffix and "ed", "ing".
        if self.b[self.k] == 's':
            if self.ends("sses"):
                self.k = self.k - 2
            elif self.ends("ies"):
    ...
    def step_two(self):
        # step2() replaces double suffices into single ones.
